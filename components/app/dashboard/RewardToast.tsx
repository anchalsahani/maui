      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="app-card-strong relative w-full max-w-sm overflow-hidden rounded-[32px] p-7 text-center shadow-[0_35px_100px_rgba(16,47,21,0.22)] backdrop-blur-2xl"
          >
            ...
            <motion.div
              ...
              className="maui-button-primary relative mx-auto flex h-16 w-16 items-center justify-center rounded-3xl"
            >
              <Trophy size={28} />
            </motion.div>
            ...
            <motion.div
              ...
              className="relative mt-5 inline-flex items-center gap-2 rounded-full bg-[var(--color-card-soft)] px-5 py-3 text-sm font-bold text-[var(--color-primary-deep)] shadow-[0_12px_28px_rgba(53,85,63,0.1)]"
            >
              <Sparkles size={16} />
