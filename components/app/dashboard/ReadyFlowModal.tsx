  ...
  return (
    <div className="grid min-h-[440px] gap-4 lg:grid-cols-[1.05fr_0.95fr]">
      ...
      >
        ...
        <div className="app-card mt-auto grid gap-3 rounded-[28px] p-4 sm:p-5">
          <div className="app-subcard grid grid-cols-4 gap-2 rounded-[22px] p-2">
              ...
              <button
                ...
                className={`h-10 rounded-full text-xs font-semibold transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-55 ${
                  selectedMinutes === minutes
                    ? "maui-button-primary"
                    : "bg-[var(--color-card-soft)] text-[var(--color-dark)] hover:-translate-y-0.5 hover:bg-[var(--color-accent)]/55"
                }`}
              >
                {minutes}m
              </button>
          ...
          <button
            type="button"
            onClick={onStart}
            className="maui-button-primary flex h-12 items-center justify-center gap-2 rounded-full text-sm font-semibold transition-all duration-200 hover:-translate-y-0.5"
          >
            {startLabel}
            <ArrowRight size={16} />
          </button>
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex h-11 items-center justify-center rounded-full border border-[var(--color-border)] bg-[var(--color-card-soft)] text-sm font-medium text-[var(--color-dark)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--color-card-hover)] disabled:cursor-not-allowed disabled:opacity-50"
            >
